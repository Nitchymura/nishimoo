    ...
    <div class="modal-dialog">
        <div class="modal-content border-danger">
            ...
            <div class="modal-body">
                Are you sure you want to deactivate <strong>{{$post->name}}</strong>?
         
                @if($post->main_image)
                    <img src="{{$post['main_image']}}" alt="" class="img-sm d-block">
                @else
...
<div class="modal fade" id="activate-post{{$post->id}}">
    <div class="modal-dialog">
        <div class="modal-content border-success">
            ...
            <div class="modal-body">
                Are you sure you want to activate <strong>{{$post->name}}</strong> ?
                @if($post->main_image)
                    <img src="{{$post->main_image}}" alt="" class="img-sm d-block">
                @else
                    <i class="fa-solid fa-image text-secondary image-sm align-middle"></i>
